...
SECRET_KEY = 'django-insecure-toliq-student-project-2026-change-in-production'
...
ROOT_URLCONF = 'toliq_project.urls'
...
WSGI_APPLICATION = 'toliq_project.wsgi.application'
